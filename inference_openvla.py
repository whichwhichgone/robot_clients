...
@dataclass
class InferConfig:
    server_url: str = "http://172.16.78.10:35317/predict"
    ...
    init_action: list = field(
        ...
        [
            ...
            0.7679836178474362,
            -0.06413355515422298,
            0.018860731946189955,
            0.0
        ]
    )

    # language instructions
    # language_instructions = ["put the corn into the bowl with blood's color.",]

    # unseen objects
    language_instructions = ["put the white block into the red bowl"]
...
class ClientRobot:
    ...
    def step(self, obs, language_instruction):
        ...
        payload = {"instruction": language_instruction}
        files = {
        ...
        while True:
            try:
                ...
                # print("action:",action)
                # print("action.status_code:",action.status_code)
